...
for (let i = 0; i < boxes.length; i++) {
    boxes[i].onclick = function () {
        ...
        else if (this.innerHTML !== "&#127796" && this.innerHTML !== "&#127774") {
            if (X_or_O % 2 === 0) {
                this.innerHTML = "&#127774";
                turn.innerHTML = "&#127796 è il tuo turno!";
                getWinner();
                X_or_O += 1;

            } else {
                this.innerHTML = "&#127796";
                turn.innerHTML = "&#127774 è il tuo turno!";
                getWinner();
                X_or_O += 1;
            }
        }
