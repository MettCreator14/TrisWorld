...
for (let i = 0; i < boxes.length; i++) {
    boxes[i].onclick = function () {
        ...
        else if (this.innerHTML !== "&#x26C4" && this.innerHTML !== "&#127877") {
            if (X_or_O % 2 === 0) {
                this.innerHTML = "&#x26C4";
                turn.innerHTML = "&#127877 è il tuo turno!";
                getWinner();
                X_or_O += 1;

            } else {
                this.innerHTML = "&#127877";
                turn.innerHTML = "&#x26C4 è il tuo turno!";
                getWinner();
                X_or_O += 1;
            }
        }
